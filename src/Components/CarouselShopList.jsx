      ...
      <Row>
        ...
        <Col sm={8}>
          <Card.Body>
            ...
            <Card.Text className="d-flex josefin">
              <span className="" style={{color:"#151875"}}>${Math.round((62 / 100) * Number(price))}</span>
            ...
            <Card.Text className="lato Wild-Blue-Yonder">{description}</Card.Text>
